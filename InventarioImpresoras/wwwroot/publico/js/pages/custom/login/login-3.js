	...
	var _handleFormSignin = function() {
		...
		FormValidation
			...
			.on('core.form.invalid', function() {
				Swal.fire({
					title: "Lo sentimos, parece que se han detectado algunos errores, int\u00E9ntalo de nuevo.",
					icon: "error",
					buttonsStyling: false,
			...
			form,
			{
				fields: {
					...
					dropEntidad: {
						validators: {
							notEmpty: {
								message: 'Ente fiscalizable es requerido'
							}
						}
					},
					txtTelefono: {
						validators: {
							notEmpty: {
								message: 'Tel&eacutefono es requerido'
							}
						}
					},
					txtCorreo: {
						validators: {
							notEmpty: {
								message: 'Correo eletr&oacutenico es requerido'
							},
							emailAddress: {
								message: 'Ingrese un correo eletr&oacutenico v\u00E1lido'
							}
						}
					}
				},
